            ...
            <ul class="navCustom" id="navSide">
                ...
                <li class="{{ Request::is( 'blog') ? 'active' : '' }}">
                    <a class="disabled" href="#">
                        <span class="glyphicon glyphicon-lock"></span>Read</a>
                </li>
                <li class="{{ Request::is( 'dashboard') ? 'active' : '' }}">
                    <a href="{{ URL::to('dashboard') }}">
                        <span class="glyphicon glyphicon-dashboard"></span>
                        <span id="badge-data" class="badge pull-right hidden"></span>Dashboard</a>
                </li>
                ...
                <li class="{{ Request::is( 'goal') ? 'active' : '' }}">
                    <a class="disabled" href="#">
                        <span class="glyphicon glyphicon-lock"></span>Acheive</a>
                </li>
                @if($isAdmin)
