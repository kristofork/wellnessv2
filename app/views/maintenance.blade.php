            ...
            <div class="col-xs-offset-2 col-xs-8 col-sm-offset-5 col-sm-2 col-md-offset-5 col-md-2">
                <div class="row row-centered welcomeIcon">
                    <div class="col-xs-4 col-sm-4 col-md-4 welcomeIconContainer">
                        <span id="iconTime" class="glyphicons glyphicons-stopwatch"></span>
                    </div>
                    <div class="col-xs-4 col-sm-4 col-md-4">
                        <span id="iconUser" class="glyphicons glyphicons-user"></span>
                        
                    </div>
                    <div class="col-xs-4 col-sm-4 col-md-4">
                        <span id="iconHeart" class="glyphicons glyphicons-heart"></span>
                    </div>                                        
                </div>
            </div>
